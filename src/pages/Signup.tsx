    ...
    <div className=" lg:w-[50%] h-screen flex  justify-center items-center">
        <div className="w-80">
          ...
          <p className="text-gray-700 text-sm font-normal text-center">
            Already have an account? <Link to='/signin' className="text-black hover:border-b-2 hover:border-black text-md font-semibold" >Sign IN</Link>
          </p>

          <form action="" onSubmit={handleSubmit}>
            <div className="my-2 ">
              <LabelInput onChange={onChangeHandler} labelName="Username" type="text" name="username" placeholder="Enter your username" value={postInputs.username}/>
            </div>
            <div className="my-2">
            ...
            <button className="w-full my-2 text-white px-6 py-1 opacity-85 bg-black hover:opacity-100 rounded border">Sign UP</button>
          </form>
