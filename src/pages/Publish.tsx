...
const Publish = () => {
    ...
    const onSubmit = async (e: any) => {
        e.preventDefault();
        axios.post(`${backend_url}/api/v1/blog`, { ...data }, {
            headers: {
    ...
    return (
        <div className="min-h-screen ">
            ...
            <div className="mt-12 max-w-2xl w-full mx-auto px-4 sm:px-6 flex flex-col gap-6">
                <h1 className="text-3xl font-semibold text-gray-800">Create a New Blog</h1>
...
function TextEditor({ onChangeHandler }: { onChangeHandler: (e: React.ChangeEvent<HTMLTextAreaElement>) => void }) {
    return (
